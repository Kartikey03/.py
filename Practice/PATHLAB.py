...
def update():
    if update_box.get() == '':
        ...
        #create save button
        b8= Button(editor, text="Save Above Record", command=edit)
        b8.grid(row=15, column=0, columnspan=2, pady=10, padx=10, ipadx=80)
...
def show_one():
    if show_box.get() == '':
        ...
        #create save button
        b9= Button(show, text="Close Record", command=close2)
...
p_id.grid(row=0, column=1, padx=60, pady=(10,0))

p_name=Entry(root, width=30)
p_name.grid(row=1, column=1)

p_age=Entry(root, width=30)
p_age.grid(row=2, column=1)

p_gender=Entry(root, width=30)
p_gender.grid(row=3, column=1)

p_blood=Entry(root, width=30)
p_blood.grid(row=4, column=1)

p_address=Entry(root, width=30)
p_address.grid(row=5, column=1)

p_tests=Entry(root, width=30)
p_tests.grid(row=6, column=1)
...
id_label=Label(root, text="Patient Id :", font=('Comic Sans Ms',10))
id_label.grid(row=0, column=0, pady=(10,0))

name_label=Label(root, text="Patient Name :", font=('Comic Sans Ms',10))
name_label.grid(row=1, column=0)

age_label=Label(root, text="Patient Age :", font=('Comic Sans Ms',10))
age_label.grid(row=2, column=0)

gend_label=Label(root, text="Patient Gender :", font=('Comic Sans Ms',10))
gend_label.grid(row=3, column=0)

blood_label=Label(root, text="Patient's Blood Group :", font=('Comic Sans Ms',10))
blood_label.grid(row=4, column=0)

add_label=Label(root, text="Patient Address :", font=('Comic Sans Ms',10))
add_label.grid(row=5, column=0)

tests_label=Label(root, text="Patient Tests :", font=('Comic Sans Ms',10))
tests_label.grid(row=6, column=0)
...
b1= Button(root, text="Add Patient Data to Database", font=('Comic Sans Ms',10), command=submit)
b1.grid(row=7, column=0, columnspan=2, pady=5, padx=10)

#create show_all query button
b2= Button(root, text="Show all Records of Patients", font=('Comic Sans Ms',10), command=show_all)
b2.grid(row=8, column=0, columnspan=2, pady=5, padx=10, ipadx=105)

#create show_one query button
b3= Button(root, text="Display Record of the Patient", font=('Comic Sans Ms',10), command=show_one)
b3.grid(row=11, column=0, columnspan=2, pady=5, padx=10, ipadx=100)

#create delete button
b4= Button(root, text="Delete Record from the Database", font=('Comic Sans Ms',10), command=delete)
b4.grid(row=13, column=0, columnspan=2, pady=5, padx=10, ipadx=93)

#create update button
b5= Button(root, text="Update Record from the Database ", font=('Comic Sans Ms',10), command=update)
b5.grid(row=15, column=0, columnspan=2, pady=5, padx=10, ipadx=90)

#create about button
b6= Button(root, text="(i) Learn More About our Pathlabs", font=('Comic Sans Ms',10), command=about)
b6.grid(row=17, column=0, columnspan=2, pady=(60,5), padx=10, ipadx=90)

#create exit button
b7= Button(root, text="EXIT DATABASE", font=('Comic Sans Ms',10), command=close1)
b7.grid(row=18, column=0, columnspan=2, pady=5, padx=10, ipadx=140)
